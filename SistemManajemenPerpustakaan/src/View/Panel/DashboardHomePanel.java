 ...
 * @author Lenovo
 */
public class DashboardHomePanel extends JFrame{
    ...
    private void initComponents() {
        ...
        int totalBuku =
                bukuController.ambilSemuaBuku().size();

        int totalAnggota =
                anggotaController.ambilSemuaAnggota().size();

        int totalDipinjam =
                transaksiController
                        .ambilTransaksiDipinjam()
                        .size();

        int totalTerlambat =
                transaksiController
                        .ambilTransaksiTerlambat()
                        .size();

        cardPanel.add(
                createCard("Total Buku",
                        String.valueOf(totalBuku))
        );

        cardPanel.add(
                createCard("Total Anggota",
                        String.valueOf(totalAnggota))
        );
        ...
        cardPanel.add(
                createCard("Terlambat",
                        String.valueOf(totalTerlambat))
        );
